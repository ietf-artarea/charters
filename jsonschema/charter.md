...
this working group is to produce a stable, reference specification of JSON Schema as a
...
To achieve this goal, the document produced by this working group may have the following scope:
