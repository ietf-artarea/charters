...
The DIEM WG will ensure maximum reuse of work for emblem representation and binding, facilitate re-use of existing protocols and capabilities, and ensure that existing standards are leveraged appropriately.
