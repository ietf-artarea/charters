...
* Describe agent-specific integration for agent authentication and authorization, including how existing and emerging mechanisms are composed and applied in AI agent scenarios. For interactions across administrative domains, describe how a receiving agent or tool can verify the authority and operation scope presented through an agent chain before acting, without deriving authority from an intermediate agent. Include confirmation and evidence requirements for AI agent operations.
