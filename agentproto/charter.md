...
* Describe agent-specific integration for agent authentication and authorization, including how existing and emerging mechanisms are composed and applied in AI agent scenarios, where authority and operation scope are verified across agent chains and administrative-domain boundaries, and the confirmation and evidence requirements for AI agent operations. Authorization and workload-identity mechanisms remain in the OAuth and WIMSE working groups, respectively.
