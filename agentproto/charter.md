...
* Identify, at the framework level, where existing authentication and authorization mechanisms are applied across agent chains and administrative domains, without defining mechanisms assigned to the OAuth or WIMSE working groups.
